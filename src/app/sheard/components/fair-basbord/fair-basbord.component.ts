...
@Component({
  selector: 'app-fair-basbord',
  templateUrl: './fair-basbord.component.html',
  styleUrls: ['./fair-basbord.component.scss']
})
export class FairBasbordComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.fairdetalis=this.fairsArr[0]
  }
